...
from sqlalchemy import String, DateTime, ForeignKey, Numeric, Boolean, func, Enum as SAEnum, ARRAY, Text, Index
...
class Category(Base):
    ...
    monthly_limit: Mapped[float | None] = mapped_column(Numeric(10, 2), nullable=True, index=True)
